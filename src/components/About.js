      ...
      <div className='flex flex-col justify-center items-center w-full h-full'>
        <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
          <div className='absolute -mt-16 pb-8 pl-4'>
            <p className='text-8xl font-bold inline opacity-10 border-b-4 border-yellow-600'>
              About
            </p>
          </div>
          <div></div>
          ...
          <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
            ...
            <div>
              ...
              for clients ranging from portfolio webpage for individuals and functional websites for small-businesses. I also love design and teaching.</p>
