  ...
  return (
    ...
    >
      <div className="max-w-[950px] mx-auto p-4 flex flex-col justify-center h-full">
        ...
        <div className="grid grid-cols-1 pt-20 md:-mt-5 md:pt-32 md:grid-cols-2 lg:grid-cols-3 gap-6 z-10 px-6">
          {data.map((project) => <ProjectCard key={project.id} project={project} />).slice(0, 6)}
        </div>
