      ...
      <div className='flex flex-col justify-center items-center w-full h-full pt-20'>
        ...
        <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
          ...
          <form method='POST' action="https://getform.io/f/a699a1b2-f225-434e-b317-1fbbde8e006c" className='relative flex flex-col max-w-[600px] w-full -mt-5 sm:mt-20 md:mt-16'>
              ...
              <button className='text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 my-8 mx-auto flex items-center dark:text-gray-800 dark:border-gray-900 dark:hover:bg-gray-600 dark:hover:border-gray-800'>Send mail</button>
          </form>
        </div>
      </div>
    </div>
