...
const Contact = () => {
  return (
    <div name='contact' className='w-full bg-[#0a192f] flex flex-col justify-center items-center p-4'>
        <div className='relative pt-32 pl-4'>
            <p className='opacity-10 text-9xl font-bold inline border-b-4 border-yellow-600'>Contact</p>
        </div>
        <form method='POST' action="https://getform.io/f/a699a1b2-f225-434e-b317-1fbbde8e006c" className='relative flex flex-col max-w-[600px] w-full'>
