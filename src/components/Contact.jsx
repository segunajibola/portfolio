const Contact = () => {
  return (
    <div
      id="contact"
      className="relative pt-24 w-full text-gray-300 bg-[#0a192f] dark:text-gray-800 dark:bg-gray-100"
    >
      <div className="flex flex-col justify-center items-center w-full h-full">
        <div className="max-w-[1000px] w-full">
          <div className="absolute top-16 pb-8 pl-4">
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          <div className="sm:text-right mt-20 text-2xl">
