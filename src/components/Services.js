...
const Services = () => {
  return (
      <div id='services' className='w-full text-gray-300 bg-[#0a192f] dark:bg-gray-100'>
      <div className='max-w-[950px] mx-auto p-4 flex flex-col justify-center h-full'>
        ...
        {/* front-end web developer, technical writer, dev advocate, open surce contributor, graphics designer */}
        </div>
